function [delta_cij delta_cij_bound] = calculateStd(mut_mat,num_patients)
% calculateStd(mut_mat,num_patients)
% 
% Calculates the standard deviation based on the mutant probability matrix

% Inputs:
%       mut_mat - mutant probability matrix
%       num_patients -  number of patients

% Outputs:
%       delta_cij - standard deviation
%       delta_cij_bound - bounded standard deviation 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
